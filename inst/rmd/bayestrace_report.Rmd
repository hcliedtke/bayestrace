...
for(i in 1:length(tre$tip.label)){
  ...
  style_node(tre$tip.labe[i], nodesizeratio = 2, fillcolor=unname(traits_colors[as.character(tre$traits)][i])) 
}
...
if(!is.null(bt$tags)){
  ...
  phylo_canv<-phylo_canv %>%
  style_node(anc_df$node_num[i], nodesizeratio = 2, fillcolor=unname(traits_colors[as.character(anc_i)])) 
  }
